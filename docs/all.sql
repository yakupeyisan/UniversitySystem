...
ALTER
DATABASE [UniversitySystem] SET OFFLINE WITH ROLLBACK IMMEDIATE;
ALTER
DATABASE [UniversitySystem] SET ONLINE;
GO
...
IF
OBJECT_ID('dbo.sp_GetPersonWalletBalance', 'P') IS NOT NULL
...
IF
OBJECT_ID('dbo.WorkflowApprovals', 'U') IS NOT NULL
DROP TABLE dbo.WorkflowApprovals;
IF
OBJECT_ID('dbo.WalletTransactionHistory', 'U') IS NOT NULL
DROP TABLE dbo.WalletTransactionHistory;
IF
OBJECT_ID('dbo.AccessLogs', 'U') IS NOT NULL
DROP TABLE dbo.AccessLogs;
IF
OBJECT_ID('dbo.AccessScheduleExceptions', 'U') IS NOT NULL
DROP TABLE dbo.AccessScheduleExceptions;
IF
OBJECT_ID('dbo.AccessGroupPermissions', 'U') IS NOT NULL
DROP TABLE dbo.AccessGroupPermissions;
IF
OBJECT_ID('dbo.SeatReservations', 'U') IS NOT NULL
DROP TABLE dbo.SeatReservations;
IF
OBJECT_ID('dbo.TicketResales', 'U') IS NOT NULL
DROP TABLE dbo.TicketResales;
IF
OBJECT_ID('dbo.TicketReservations', 'U') IS NOT NULL
DROP TABLE dbo.TicketReservations;
IF
OBJECT_ID('dbo.TrainingSessions', 'U') IS NOT NULL
DROP TABLE dbo.TrainingSessions;
IF
OBJECT_ID('dbo.VirtualPosIntegrations', 'U') IS NOT NULL
DROP TABLE dbo.VirtualPosIntegrations;
IF
OBJECT_ID('dbo.SettlementDiscrepancies', 'U') IS NOT NULL
DROP TABLE dbo.SettlementDiscrepancies;
IF
OBJECT_ID('dbo.SettlementReports', 'U') IS NOT NULL
DROP TABLE dbo.SettlementReports;
IF
OBJECT_ID('dbo.StudentAssignments', 'U') IS NOT NULL
DROP TABLE dbo.StudentAssignments;
IF
OBJECT_ID('dbo.StudentFees', 'U') IS NOT NULL
DROP TABLE dbo.StudentFees;
IF
OBJECT_ID('dbo.ScholarshipDeductions', 'U') IS NOT NULL
DROP TABLE dbo.ScholarshipDeductions;
IF
OBJECT_ID('dbo.MessageRecipients', 'U') IS NOT NULL
DROP TABLE dbo.MessageRecipients;
IF
OBJECT_ID('dbo.Messages', 'U') IS NOT NULL
DROP TABLE dbo.Messages;
IF
OBJECT_ID('dbo.MealPlans', 'U') IS NOT NULL
DROP TABLE dbo.MealPlans;
IF
OBJECT_ID('dbo.MazeretRaporlari', 'U') IS NOT NULL
DROP TABLE dbo.MazeretRaporlari;
IF
OBJECT_ID('dbo.ParkingEntryExitLog', 'U') IS NOT NULL
DROP TABLE dbo.ParkingEntryExitLog;
IF
OBJECT_ID('dbo.ParkingCards', 'U') IS NOT NULL
DROP TABLE dbo.ParkingCards;
IF
OBJECT_ID('dbo.VehicleRegistration', 'U') IS NOT NULL
DROP TABLE dbo.VehicleRegistration;
IF
OBJECT_ID('dbo.UserRoles', 'U') IS NOT NULL
DROP TABLE dbo.UserRoles;
IF
OBJECT_ID('dbo.SeatingArrangement', 'U') IS NOT NULL
DROP TABLE dbo.SeatingArrangement;
IF
OBJECT_ID('dbo.Seats', 'U') IS NOT NULL
DROP TABLE dbo.Seats;
IF
OBJECT_ID('dbo.AuditLogs', 'U') IS NOT NULL
DROP TABLE dbo.AuditLogs;
IF
OBJECT_ID('dbo.Addresses', 'U') IS NOT NULL
DROP TABLE dbo.Addresses;

-- Level 2: Base/Independent tables
IF
OBJECT_ID('dbo.TrainingPrograms', 'U') IS NOT NULL
DROP TABLE dbo.TrainingPrograms;
IF
OBJECT_ID('dbo.VirtualPosProviders', 'U') IS NOT NULL
DROP TABLE dbo.VirtualPosProviders;
IF
OBJECT_ID('dbo.SystemNotifications', 'U') IS NOT NULL
DROP TABLE dbo.SystemNotifications;
IF
OBJECT_ID('dbo.SystemSettings', 'U') IS NOT NULL
DROP TABLE dbo.SystemSettings;
IF
OBJECT_ID('dbo.Roles', 'U') IS NOT NULL
DROP TABLE dbo.Roles;
IF
OBJECT_ID('dbo.AccessGroups', 'U') IS NOT NULL
DROP TABLE dbo.AccessGroups;
IF
OBJECT_ID('dbo.AccessPoints', 'U') IS NOT NULL
DROP TABLE dbo.AccessPoints;
IF
OBJECT_ID('dbo.AccessChannels', 'U') IS NOT NULL
DROP TABLE dbo.AccessChannels;
IF
OBJECT_ID('dbo.AccessCards', 'U') IS NOT NULL
DROP TABLE dbo.AccessCards;
IF
OBJECT_ID('dbo.Wallets', 'U') IS NOT NULL
DROP TABLE dbo.Wallets;
IF
OBJECT_ID('dbo.Persons', 'U') IS NOT NULL
...
PRINT
'Sample Data: Inserted default records';
PRINT
'========================================';
GO