...
public class PrerequisiteRepository : GenericRepository<Prerequisite>, IPrerequisiteRepository
{
    ...
    public async Task<IEnumerable<Prerequisite>> GetByPrerequisiteCourseAsync(Guid prerequisiteCourseId,
    ...
    public async Task<Prerequisite?> GetByCoursesAsync(Guid courseId, Guid prerequisiteCourseId,
        CancellationToken ct = default)
    {
