...
public class PrerequisiteWaiverRepository : GenericRepository<PrerequisiteWaiver>, IPrerequisiteWaiverRepository
{
    ...
    public async Task<PrerequisiteWaiver?> GetByStudentAndPrerequisiteAsync(Guid studentId, Guid prerequisiteId,
    ...
    public async Task<IEnumerable<PrerequisiteWaiver>> GetApprovedWaiversAsync(Guid studentId,
        CancellationToken ct = default)
    {
